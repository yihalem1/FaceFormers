...
def main(rank, world_size, train_opt):
    ...
    times = []
    for epoch in tqdm(range(train_opt.epoch_count, train_opt.n_epochs + 1)):    # outer loop for different epochs; we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>
